 ...
 *//*!
 * @file	   asfbep.cpp
 * @brief	   AS isochronous feedback endpoint implementation.
...
#define STR_MODULENAME "asfbep: "


#pragma code_seg("PAGE")

/*****************************************************************************
 * CAsIsochronousFeedbackEndpoint::~CAsIsochronousFeedbackEndpoint()
 *****************************************************************************
 */
...
/*****************************************************************************
 * CAsIsochronousFeedbackEndpoint::Init()
 *****************************************************************************
 */
NTSTATUS
CAsIsochronousFeedbackEndpoint::
...
/*****************************************************************************
 * CAsIsochronousFeedbackEndpoint::GetOtherUsbAudioDescriptorSize()
 *****************************************************************************
 */
ULONG 
CAsIsochronousFeedbackEndpoint::
...
/*****************************************************************************
 * CAsIsochronousFeedbackEndpoint::GetOtherUsbAudioDescriptor()
 *****************************************************************************
 */
ULONG 
CAsIsochronousFeedbackEndpoint::
...
)
{
	...
	EndpointDescriptor->bmAttributes |= 0x10; // feedback endpoint
	EndpointDescriptor->wMaxPacketSize = m_EndpointDescriptor->wMaxPacketSize;
	EndpointDescriptor->bInterval = 1 << m_EndpointDescriptor->bRefresh;
